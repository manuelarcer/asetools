...
class TestBondValenceSum:
    ...
    def test_simple_structure(self):
        ...
        atoms = Atoms(
            "TiO2", positions=[[0, 0, 0], [1.2, 0, 0], [0, 1.2, 0]], cell=[4, 4, 4], pbc=True
        )
    ...
    def test_custom_parameters(self):
        ...
        valence_states = {"Ti": 4, "O": -2}
        bvs_calc = BondValenceSum(
            atoms, valence_states=valence_states, custom_parameters=custom_params
        )
    ...
    def test_distance_cutoff(self):
        ...
        bvs_calc_short = BondValenceSum(atoms, valence_states=valence_states, distance_cutoff=2.0)
        bvs_calc_long = BondValenceSum(atoms, valence_states=valence_states, distance_cutoff=5.0)
...
class TestBondValenceIntegration:
    ...
    def test_layered_oxide_coordination(self):
        ...
        atoms = read("tests/data/summary_test/0_1.2/CONTCAR")
    ...
    def test_allowed_pairs_specification(self):
        ...
        bvs_calc = BondValenceSum(
            atoms, valence_states=valence_states, allowed_pairs=[("Ti", "O")], distance_cutoff=3.0
        )
    ...
    def test_exclude_same_element_pairs(self):
        ...
        bvs_calc = BondValenceSum(
            atoms, valence_states=valence_states, exclude_same_element=True, distance_cutoff=2.5
        )
        ...
        bvs_calc_include = BondValenceSum(
    ...
    def test_auto_determine_valence(self):
        ...
        bvs_calc = BondValenceSum(
            atoms, valence_states={"O": -2}, auto_determine_valence=True, distance_cutoff=3.0
        )
    ...
    def test_metal_element_detection(self):
        ...
        if opt_results:
            assert (
                "Ti" in opt_results or len(opt_results) == 0
